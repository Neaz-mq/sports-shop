...
const NavBar = () => {
    ...
    const navOptions = <>
        ...
        <li  className="hover:bg-red-600 rounded-lg font-semibold text-red-600 lg:text-white"><Link to="/menu">Our Menu</Link></li>
        <li  className="hover:bg-red-600 rounded-lg font-semibold text-red-600 lg:text-white"><Link to="/order/salad">Order Food</Link></li>
